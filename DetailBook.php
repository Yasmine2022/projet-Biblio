...
<body>
    ...
    foreach ($livre as $r) {
        ...
        if ($id == $det) {
            ...
            $categorie = $r->getElementsByTagName('categorie')->item(0)->textContent;
            $nom = $r->getElementsByTagName('nom')->item(0)->textContent;
            $prenom = $r->getElementsByTagName('prenom')->item(0)->textContent;
            $edition = $r->getElementsByTagName('edition')->item(0)->textContent;
            $date = $r->getElementsByTagName('date_Emprunt')->item(0)->textContent;
            $image = $r->getElementsByTagName('image')->item(0)->getAttribute('src');
            $description = $r->getElementsByTagName('description')->item(0)->textContent;
        }
    }
    ?>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <div style="font-family: 'Times New Roman', Times, serif;" class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 style="font-size: 18px;" class="section-title bg-white text-center text-primary px-3">Information</h6>
                        <h1 class="mb-5"><?=$titre?></h1>
                    </div>
                    <p class="mb-4"><?= $nom ?><?= $prenom ?> | <?= $date ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Description:</h4><?= $description ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Categorie:</h4><?= $categorie ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Edition:</h4><?= $edition ?></p>
                </div>
            </div>
        </div>
    </div>
