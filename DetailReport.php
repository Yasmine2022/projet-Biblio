        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4"><?= $etudiant ?> | <?= $date ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Specialite:</h4><?= $specialite ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Stage:</h4><?= $stage ?></p>
                    <p class="mb-4">
                    <h6 style="color:#2C547C">Jury:</h4><?= $encadreur ?></p>
                </div>
            </div>
        </div>
    </div>
