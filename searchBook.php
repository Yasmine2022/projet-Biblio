                                ...
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="search_field">
                                            ...
                                            <option value="date_Emprunt">date_Emprunt</option>
                                        </select>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $result = '';
                                foreach ($xml->livre as $biblio) {
                                    $aut = $biblio->auteurs->auteur;
                                    if (strtolower($aut->$search_field) == strtolower($search_query) || strtolower($biblio->Info_Emput->$search_field) == strtolower($search_query) || strtolower($biblio->$search_field) == strtolower($search_query)) {
                                        $result .= '<tr><td>' . $biblio->titre . '</td><td> ' . $aut->nom . '</td><td> ' . $biblio->categorie . '</td><td>' . $biblio->Info_Emput->date_Emprunt . '</td></tr>';
                                    }
                                }
                                if ($result) {
                                    echo $result;
